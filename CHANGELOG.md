...
## [0.3.5] - 2026-01-17
### Added
- New `GET /addresses/{address}/rewards/count` endpoint to return the count and sum of rewards for a specific address, with optional `unconfirmed` query parameter.
